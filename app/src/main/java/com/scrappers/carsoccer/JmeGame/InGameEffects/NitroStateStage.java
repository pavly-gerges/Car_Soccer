...
public class NitroStateStage extends BaseAppState {
    ...
    public NitroStateStage(AssetManager assetManager, Node nitroNode,Vector3f gravity, String effectName,ColorRGBA colorRGBA1,ColorRGBA colorRGBA2){
